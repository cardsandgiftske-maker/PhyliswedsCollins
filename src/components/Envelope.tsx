    ...
    >
      ...
      >
        ...
        <div className="relative w-full h-full bg-[#8B1E3F] rounded-[36px] overflow-hidden shadow-2xl flex flex-col justify-between border border-[#A82B52]/40">
          ...
          {/* Top Header Text (Subtle Luxury Branding) */}
          <div className="relative z-10 w-full text-center pt-8 px-6 pointer-events-none">
            <span className="text-[10px] tracking-[0.3em] uppercase font-sans font-extrabold text-amber-200/90 drop-shadow-sm">
              You're Cordially Invited
            </span>
            <h1 className="font-serif text-xl font-bold tracking-[0.12em] text-white/95 mt-1 drop-shadow-md">
              PHYLIS &amp; COLLINS
            </h1>
          </div>
                ...
                >
                  ...
                  <div className="relative w-32 h-32 sm:w-36 sm:h-36 flex items-center justify-center filter drop-shadow-[0_12px_24px_rgba(0,0,0,0.65)] transition-transform duration-300 active:scale-95 group-hover:scale-105">
                    ...
                    <svg className="w-full h-full" viewBox="0 0 120 120" fill="none">
                      ...
                      {/* Monogram P | C centered matching V | D in the photo */}
                      <g filter="url(#seal-3d-shadow)">
                        ...
                        {/* Thin vertical line divider matching V | D style */}
                        <line 
                          x1="60" 
                          y1="40" 
                          x2="60" 
          ...
          {/* Bottom Footer Hashtag / Date */}
          <div className="relative z-10 w-full text-center pb-8 px-6 pointer-events-none flex flex-col items-center gap-1">
            <span className="text-amber-200/90 font-serif italic text-xs tracking-widest drop-shadow-sm">
              22nd August 2026 • Nairobi, Kenya
            </span>
