...
export const PROGRAM_ITEMS: ProgramItem[] = [
  ...
  },
  {
    ...
    description: "Bridal party photoshoot in the church grounds as guests transition to St Mary's Msongari main school rugby pitch.",
    isChurch: false,
  },
  {
    ...
    description: "Guests arrive at St Mary's Msongari main school rugby pitch, ushered to assigned tables with welcome refreshments.",
    isChurch: false,
  },
  {
...
export const INITIAL_GALLERY: GalleryPhoto[] = [
  ...
  },
  {
    ...
    caption: "St Mary's Msongari main school rugby pitch",
